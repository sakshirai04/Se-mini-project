    ...
    <asp:GridView ID="GridView1" runat="server" Width="100%" 
           ...
           onselectedindexchanged="GridView1_SelectedIndexChanged1">
            <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:LinkButton ID="LinkButton1"  runat="server" CommandArgument='<%#Eval("foodno")%>' Text ="Delete Item" CommandName ="Delete" Font-Bold="True" Font-Size="Large" Font-Underline="True" style="font-family: candara; color: #CC0000" OnClientClick="Confirm()"></asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
