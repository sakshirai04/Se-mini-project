<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserBill.aspx.cs" Inherits="UserBill" %>
...
<body  style="background-image: url('images/FoodBackground.jpg')">
    ...
    <div>
        ...
        <table class="auto-style1" width="100%" style="border: 2px solid #808080;">
            <tr>
            ...
            <tr>
                <td align="center" width="33.33%" style="border-right: 1px solid #C0C0C0; font-family: calibri; font-weight:bold; "  class="auto-style4">
                    <asp:PlaceHolder ID="p1" runat="server"></asp:PlaceHolder>
                </td>
                <td align="center" width="33.33%" style="border-right: 1px solid #C0C0C0; font-family: calibri;font-weight:bold;  " class="auto-style4">
                    <asp:PlaceHolder ID="p2" runat="server"></asp:PlaceHolder>
                </td>
                <td align="center" width="33.33%" style="font-family: calibri;font-weight:bold;" class="auto-style4">
                    <asp:PlaceHolder ID="p3" runat="server"></asp:PlaceHolder>
                </td>
            </tr>
            <tr>
                <td width="33.33%" style="border-top-style: solid; border-right-style: solid; border-top-width: 2px; border-right-width: 1px; border-top-color: #C0C0C0; border-right-color: #C0C0C0;   font-weight:bold ; font-size:large" align="right" class="auto-style4" colspan="2" class="auto-style4"><strong>Total :</strong></td>
                <td align="center" width="33.33%" style="border-top-style: solid; border-width: 2px; border-color: #C0C0C0" class="auto-style4">
                    <asp:Label ID="lblTotal" runat="server" 
                        style="font-weight: 700; font-size: large; font-family: calibri" 
                        class="auto-style4"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
